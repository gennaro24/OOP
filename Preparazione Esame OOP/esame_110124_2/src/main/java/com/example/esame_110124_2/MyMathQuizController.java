package com.example.esame_110124_2;
...
public class MyMathQuizController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        BooleanBinding bottoneInizia = Bindings.createBooleanBinding(() -> nome.getText().isEmpty() || cognome.getText().isEmpty() || numeroDomande.getText().isEmpty()
                , nome.textProperty() , cognome.textProperty() , numeroDomanda.textProperty());
